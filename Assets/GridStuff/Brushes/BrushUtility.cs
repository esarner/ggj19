...
namespace Assets.GridStuff.Brushes
{
   public class BrushUtility
   {
      ...
      public static Grid GetRootGrid(bool autoCreate = false)
      {
         Grid result = null;
      ...
      public static GridInformation GetRootGridInformation(bool autoCreate = false)
      {
...
#else
				result
= layer.gameObject.AddComponent<Tilemap>();
